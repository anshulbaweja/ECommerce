...
if(!defined('WP_MIGRATION_DUPLICATOR_VERSION')) //check plugin file already included
{
     ...
     */
    define('WP_MIGRATION_DUPLICATOR_VERSION', '1.2.0' );
}
...
if(!function_exists('wt_missing_plugins_warning')){
    function wt_missing_plugins_warning() {
        if(!extension_loaded('zip')){            
            ...
            $message = sprintf(__('<b>Wordpress Backup & Migration</b> has been activated. To ensure proper functioning, kindly enable the <b>ZipArchive extension</b> in server. <a href="%s" target="_blank">Learn more here.</a>'),'https://bobcares.com/blog/enable-php-zip-extension-cpanel/');
